...
- Tiebreaker for equal scores: POTY count (descending), then YPOTY count (descending)
...
2. Add announced POTY, YPOTY, and TOTY entries to `src/data/awards.ts` under the new season (e.g. `"2025-26"`). It is fine to add POTY and YPOTY before TOTY has been announced.
